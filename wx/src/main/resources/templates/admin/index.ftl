...
<div class="wrapper">
    ...
    <div id="mainPanel" class="content-wrapper">
    ...
    <aside class="control-sidebar control-sidebar-dark">
        ...
        <ul class="nav nav-tabs nav-justified control-sidebar-tabs">
            <li><a href="/admin/#control-sidebar-home-tab" data-toggle="tab"><i class="fa fa-home"></i></a></li>
            <li><a href="/admin/#control-sidebar-settings-tab" data-toggle="tab"><i class="fa fa-gears"></i></a></li>
        </ul>
        <!-- Tab panes -->
            ...
            <div class="tab-pane" id="control-sidebar-settings-tab">
                <form method="post">
                    ...
                    <div class="form-group">
                        <label class="control-sidebar-subheading">
                            Delete chat history
                            <a href="/admin/javascript:void(0)" class="text-red pull-right"><i class="fa fa-trash-o"></i></a>
                        </label>
                    </div>
                    <!-- /.form-group -->
                </form>
