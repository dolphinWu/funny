        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="active treeview">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <ul class="treeview-menu">
                    <li class="active"><a href="javascript:void(0);" onclick="loadPage('mainPanel', '/admin/userManager?pageSize=10')"><i class="fa fa-circle-o"></i> 用户管理</a></li>
                    <li><a href="/admin/index2.html"><i class="fa fa-circle-o"></i> 角色管理</a></li>
                    <li><a href="/admin/index2.html"><i class="fa fa-circle-o"></i> 资源管理</a></li>
                </ul>
            </li>
            <li class="treeview">
                <a href="/admin/#">
              ...
              <span class="label label-primary pull-right">4</span>
                ...
                <ul class="treeview-menu">
                    <li><a href="/admin/pages/layout/top-nav.html"><i class="fa fa-circle-o"></i> Top Navigation</a>
                    </li>
                    ...
                    <li><a href="/admin/pages/layout/collapsed-sidebar.html"><i class="fa fa-circle-o"></i> Collapsed
                        Sidebar</a></li>
                </ul>
            </li>
            <li>
            ...
            <li class="treeview">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <ul class="treeview-menu">
                    <li><a href="/admin/pages/forms/general.html"><i class="fa fa-circle-o"></i> General Elements</a>
                    </li>
                    <li><a href="/admin/pages/forms/advanced.html"><i class="fa fa-circle-o"></i> Advanced Elements</a>
                    </li>
            ...
            <li class="treeview">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <ul class="treeview-menu">
                    ...
                    <li><a href="/admin/pages/examples/lockscreen.html"><i class="fa fa-circle-o"></i> Lockscreen</a>
                    </li>
